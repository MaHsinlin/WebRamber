...
<body style="background-color: #f0f0f0">
    ...
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item" style="width: 28%;margin-left: 28%;height: 3rem;margin-top: 1.2rem">
            <div class="layui-input-block" style="height: 100%;width: 100%">
                <input style="height: 100%;border-radius: 1.4rem" type="password" name="password" required lay-verify="required" placeholder="密码" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item" style="width: 28%;margin-left: 28%;height: 3rem;margin-top: 1.2rem">
            <div class="layui-input-block" style="height: 100%;width: 100%">
                <input style="height: 100%;border-radius: 1.4rem" type="text" name="title" required  lay-verify="required" placeholder="请输入不超过15位字符的昵称" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item" style="width: 28%;margin-left: 28%;height: 2.2rem;margin-top: 1.2rem">
            <div class="layui-input-block" style="height: 100%;width: 100%">
                <button onclick="register_onclick()" style="height: 100%;width: 100%;border-radius: 1rem;background-color: #4e7af7" class="layui-btn" lay-submit lay-filter="formDemo">点击注册</button>
            </div>
        </div>
        <div class="layui-form-item" style="width: 28%;margin-left: 28%;height: 2.2rem;margin-top: 1.2rem">
            <div class="layui-input-block" style="height: 100%;width: 100%">
                <a href="./login.jsp" style="float: left">登录</a>
            </div>
        </div>
